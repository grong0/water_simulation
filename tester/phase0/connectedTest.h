...
void createTestBodies(Body* bodies, Hole* holes) {
    ...
    bodies[0] = Body{ true   , 10.0f*20     , 4.0f*20       , 1.0f*20 , 0.0f*20 + 50 , 0.0f*20 + 250 }; // Body 1
    bodies[1] = Body{ true   , 2.0f *20     , 2.0f*20       , 1.0f*20 , 1.0f*20 + 50 , 0.0f*20 + 250 }; // Body 2
    ...
    holes[0] = Hole{ 1*20      , 1*20 + 50, 1*20 + 250, HORIZONTAL, &bodies[0], &bodies[1] };
    holes[1] = Hole{ 1*20      , 1*20 + 50, 1*20 + 250, HORIZONTAL, &bodies[1], &bodies[2] };
}
