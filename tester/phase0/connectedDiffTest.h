...
// Create test bodies      isCapped, maxHeight, waterHeight, width, pos_x, pos_y
    bodies[0] = body_t{false   , 8.0f     , 3.0f       , 1.0f , 0.0f , 0.0f}; // Body 1
    bodies[1] = body_t{true    , 1.0f     , 1.0f       , 1.0f , 1.0f , 2.0f}; // Body 2
    bodies[2] = body_t{false   , 3.0f     , 2.5f       , 1.0f , 2.0f , 1.0f}; // Body 3
}
